...
class Stats extends Component {
    render(props) {
        ...
        const num = stats.efficiency ? Math.round(stats.efficiency * 10000) / 100 : 0;
...
class Container extends Component {
    ...
    render(props, state) {
        ...
        return <div className="contents">
            <textarea className="input io" onInput={e => this.minify(e)} spellCheck="false" placeholder="ここへCSSを挿入してください" autofocus />
